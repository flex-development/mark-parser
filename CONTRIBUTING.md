...
1. Clone repository
   ...
   ```sh
   git clone https://github.com/flex-development/mark-parser
   cd mark-parser
   ```
...
```sh
https://github.com/flex-development/mark-parser/compare/main...$branch
```
...
[qa]: https://github.com/flex-development/mark-parser/discussions/new?category=q-a
